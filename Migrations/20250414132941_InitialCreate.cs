    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TodoContainers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TodoContainers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                })
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TodoItems_TodoContainers_ContainerId",
                        column: x => x.ContainerId,
                        principalTable: "TodoContainers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TodoContainers_UserId",
                table: "TodoContainers",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_TodoItems_ContainerId",
                table: "TodoItems",
                column: "ContainerId");
        }
